...
public class DepositHistoryFragment extends Fragment {
    ...
    */
    ...
    public final View onCreateView(final LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(R.layout.fragment_deposit_history,
                                         container, false);
    ...
    public final void showHistory(final View view) {
        if (!fromDateText.getText().toString().equals("")
            ...
            transactions = db.getDeposits(currentUser,
                    fromDateText.getText().toString(),
                    toDateText.getText().toString());

            historyText.setText(HistoryHelper.depositHistory(transactions));
